...
impl Default for ReportOptions {
    fn default() -> Self {
        Self {
            title: "NeoRAG Retrieval Report".to_string(),
...
"#,
    ...
    h.push_str(&format!(
        r#"<p class="foot">Generated by neorag-calibration. All numbers measured from {n} query outcomes; no view-specific recomputation. Cost units are abstract — set <code>CostModel</code> to your deployment's real figures for a $/latency readout.</p>"#
    ));
