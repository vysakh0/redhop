...
is not applied to LlamaIndex; see
[`CUAD_CLAUSE_EXPANSION.md`](docs/findings/CUAD_CLAUSE_EXPANSION.md) for the
controlled three-arm run. All without a vector database, an agent framework,
or model finetuning.
